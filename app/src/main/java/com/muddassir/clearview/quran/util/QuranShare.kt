package com.muddassir.clearview.quran.util
 ...
 * ([com.muddassir.clearview.quran.widget.QuranReminderWidgetProvider]) and the
 * full verse screen ([com.muddassir.clearview.quran.ui.QuranVerseActivity]) so
